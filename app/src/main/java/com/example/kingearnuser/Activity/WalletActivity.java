...
public class WalletActivity extends AppCompatActivity {
    ...
    private void initialize(Bundle _savedInstanceState) {
        ...
        bkash = (ImageView) findViewById(R.id.paytm);
        nagad = (ImageView) findViewById(R.id.gpay);
        rocket = (ImageView) findViewById(R.id.phonepay);
        topup = (ImageView) findViewById(R.id.amezonpay);
                    ...
                    if (_childValue.containsKey("balance")) {
                        ...
                        textview7.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View _view) {
                                ...
                                dialog1.setMessage("💎 ".concat(new DecimalFormat("#,##,##,###.##")
                                        .format(Double.parseDouble(_childValue.get("balance").toString())))
                                        .concat(" = ".concat("💰 ".concat(new DecimalFormat("#,##,##,###.##")
                                                .format(Double.parseDouble(_childValue.get("balance").toString()) / 50)))));
                                ...
                                if (Double.parseDouble(_childValue.get("balance").toString()) > 0) {
                                    dialog1.setNeutralButton("Convert", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface _dialog, int _which) {
                                            m = new HashMap<>();
                                            m.put("money", new DecimalFormat("0.00").format(Double.parseDouble(_childValue.get("money").toString())
                                                    + (Double.parseDouble(_childValue.get("balance").toString()) / 50)));
                                            m.put("balance", "0");
                        ...
                        public void onClick(View _view) {
                            if (!payment.equals("") && (!edittext_amount.getText().toString().equals("") && !edittext_number.getText().toString().equals(""))) {
                                if (!(Double.parseDouble(edittext_amount.getText().toString()) < 50)) {
                                    ...
                                    SketchwareUtil.showMessage(getApplicationContext(), "Minimum withdraw 50 ₹");
                                }
                            } else {
